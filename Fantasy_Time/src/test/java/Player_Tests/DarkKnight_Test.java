...
public class DarkKnight_Test {
    ...
    @Test
    public void canHealthLimitDefenceVitality() {
        darkKnight.takeDamage(499);
        darkKnight.healthLimit();
        assertEquals(140, darkKnight.getVitality());
    }

    @Test
    public void canArmourLimitHealthIncrease() {
        darkKnight.takeArmourDamage(99);
        darkKnight.armourLimit();
        assertEquals(1500, darkKnight.getHealthValue());
    }

    @Test
    public void canArmourLimitCuresPoison() {
        darkKnight.getsPoisoned();
        darkKnight.armourLimit();
        assertEquals(false, darkKnight.getPoisonStatus());
    }
